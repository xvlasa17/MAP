...
The deadline is **Monday, 18 May 2026, 23:59**.

Use the `project` tag or branch to ensure easy identification of your solution, and send an e-mail to <tomas.lazna@ceitec.vutbr.cz> informing that your project is finished.
